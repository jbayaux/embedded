...
; *********************************************************** ;
    ...
    #define measure_counter_init_L 0x0A ; 0xB5
    #define measure_counter_init_H 0x00 ; 0x06
...
initialisation:
    ...
    banksel  PIE1
    movlw    01100001B
    movwf    PIE1                   ; Enable timer1, ADC and EUSART receive interrupts
    ...
    measure_stop_writing_bit EQU 0x00 ; Bit 0 : flag to stop writing data (no more free space)
...
timer1_counter_H_check:
    ...
    btfsc    measure_status_flags, 0 ; Check if there is still some space available for measurements
    return
    bsf      measure_task_flags, measure_temp_bit ; Start task for temp measurement
    return
