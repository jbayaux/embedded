...
initialisation:
    ...
    movlb 02h
    movlw 00000000B
    movwf LATD ; ((PORTD) and 07Fh), 0 ..7 = 0;
...
reset_tmr1:
    ...
    movlw 10011110B
    movwf TMR1H
    movlw 01011000B ; TMR1 initial value = 40536
    movwf TMR1L
    return
...
timer1_handler:
    movlb 02h
    bsf LATD, 1 ; Switch on LED on ((PORTD) and 07Fh), 1
    ...
    movlw 00000001B
    xorwf LATD, 1 ; ((PORTD) and 07Fh), 0 = !((PORTD) and 07Fh), 0
...
timer1_interrupt_continue:
    ...
    movlb 02h
    bsf LATD, 1 ; Switch of LED on ((PORTD) and 07Fh), 1
    return
